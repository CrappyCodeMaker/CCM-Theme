...
export const settings = {
	...
	'settings.modifiedItemIndicator': ['violet', 400],
	// Dropdown background
	'settings.dropdownBackground': ['neutral', 800],
	// Dropdown foreground
	'settings.dropdownForeground': DEFAULT,
	// Dropdown border
	'settings.dropdownBorder': ['neutral', 900],
	// Dropdown list border
	'settings.dropdownListBorder': ['neutral', 900],
	// Checkbox background
	...
	'settings.rowHoverBackground': ['neutral', 600],
	// Text input box background
	'settings.textInputBackground': ['neutral', 800],
	...
	'settings.numberInputBackground': ['neutral', 800],
	...
	'settings.focusedRowBackground': ['neutral', 600],
	// The color of the row's top and bottom border when the row is focused
	'settings.focusedRowBorder': ['violet', 400],
	...
	'settings.settingsHeaderHoverForeground': ['neutral', 100],
};
